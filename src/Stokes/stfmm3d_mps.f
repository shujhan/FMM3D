...
c     2     nterms(i), source(1,i), npts, potl(1,1,i),
c     3     wlege, nlege)
...
c  Use lfmm3d it is correct 
     ...
     2     targ,ifpghtargl,pottargl,gradtargl,hesstargl,ier)
      ...
      call prin2('via fmm, potential = *', potl, 10)
      call prin2('via fmm, grad = *', gradl, 10)
